...
<body>
	      ...
	      <form class="navbar-form navbar-right" method="post" role="form">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li class="active">
                        <a style="background-color:#080808;" href="curated.php"><i class="fa fa-fw fa-file"></i>Non Curated</a>
                    </li>
                    <li>
       ...
       <div id="page-wrapper">
		  ...
		  <div class="col-lg-12">
                        <h1 class="page-header">
                            Pending Feeds
                            <small>Showing all the incomplete records</small>
                        </h1>
	...
	<!--		<?php echo "<form method='post'>";
		//	if(!empty($_POST['pageno'])
			//	echo "Shit"	//$_POST['pageno']=1;
			echo "Page Number"; 			
			echo "<input type=submit value='PNO' name ='pageno' /><br>";
			$_POST['pageno'] += 1;
			echo $_POST['pageno']; ?> 
			
			</form>  
			<?php echo $_POST['pageno'] ?>	-->
                ...
                <!-- /.row -->
<?php
			$query= array("Curated" => 3); //3=>Non-Curated
			$cursor = $collection->find($query, array("_id" => false));
			//$total = $collection->find($query, array("_id" => false)).count();
			//echo $total;
//			print_r($cursor);
//			echo "<br>-----------------------------------------------------<br>";
		...
		//	print_r($arr_list);
			...
			//$min = $_POST['numberoff']*10;
			//$max = ($_POST['numberoff']+1)*10;
			//echo "Showing Feeds Between"."<p>".$min.'-'.$max."</p>";
			//echo "<p>".$max."</p>";
			$count =0;
			//echo $page.'\n';
