	      ...
	      <form class="navbar-form navbar-right" method="post" role="form">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li class="active">
                        <a style="background-color:#080808;" href="partial_curated.php"><i class="fa fa-fw fa-file"></i>Partially Curated</a>
                    </li>
                    <li>
       ...
       <div id="page-wrapper">
		  ...
		  <div class="col-lg-12">
                        <h1 class="page-header">
                            Partially Curated Feeds
                            <small>Showing all the Partially Curated Records</small>
                        </h1>
		...
		//	$page  = isset($_GET['page']) ? (int) $_GET['page'] : 1;
			...
			$prev  = ($page - 1);?> 
                ...
                <!-- /.row -->
<?php
			$query= array("Curated" => 1); //3=>Non-Curated
